...
class AboutTab(QWidget):
    def __init__(self):
        ...
        # Left Side
        credits_l = QLabel("<h3><a href=\"https://codepoems.eu\">CodePoems.eu</a></h3>Version 0.7<br>contact@codepoems.eu<br>XL Converter is licensed under <a href=\"LICENSE.txt\">GPL v3</a><br><a href=\"LICENSE_3RD_PARTY.txt\">3rd party licenses")
