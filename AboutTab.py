...
class AboutTab(QWidget):
    def __init__(self):
        ...
        # Left Side
        credits_l = QLabel("<h3>XL Converter</h3>Version 0.9<br>contact@codepoems.eu<br>XL Converter is licensed under <a href=\"LICENSE.txt\">GPL v3</a><br><a href=\"LICENSE_3RD_PARTY.txt\">3rd party licenses")
